...
def som_iter(d_samples, d_weights, d_nums, d_denums, sigma_squared):
    ...
    cuda.syncthreads()    
\end{minted}
\captionof{listing}{Primer fragmento del kernel som\_iter.\\}
\label{code:somiter1}
\end{code}
...
\begin{minted}[fontsize=\footnotesize]{python}
    ...
    cuda.syncthreads()
\end{minted}
\captionof{listing}{Segundo fragmento del kernel som\_iter.\\}
\label{code:somiter2}
\end{code}
